...
static constexpr auto s_tag = "[KShortLifetimeAnalyzer]";

TEST_CASE("Standard checks of KShortLifetimeAnalyzer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("KShortLifetimeAnalyzer"
